 ...
 * CA itself.
 *
 * These credentials are part of the BlackBerry Dynamics app-based User
 * Credentials Profile (UCP) configuration.
 * 
 ...
 * after they have been imported. If successful, the state of the profile will change to
