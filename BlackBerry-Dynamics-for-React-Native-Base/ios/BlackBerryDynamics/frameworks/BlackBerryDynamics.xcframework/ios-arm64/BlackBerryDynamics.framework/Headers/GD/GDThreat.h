...
* to analyze the app package. Requires BlackBerry "Mobile Threat Defense" to be enabled.
    */
    AppMalware = 0,
...
* official app store pose a security risk. Requires BlackBerry "Mobile Threat Defense" to be enabled.
    */
    AppSideload = 1,
...
* accumulated knowledge from threat intelligence feeds to provide an assessment of the safety of the URL. Requires "Mobile Threat Defense"
* to be enabled. Use GD.SafeUrl::checkUrl to check specific URLs or IPs.
    */
    SafeBrowsing = 4,
...
* phishing attempts, malware, adware, and other web sources that pose a threat. Requires BlackBerry "Mobile Threat Defense" to be enabled.
    */
    SafeMessaging = 5,
...
* against geozones set by an administrator. Requires BlackBerry Persona to be enabled.
    */
    GeoZone = 6,
...
* app store pose a security risk. Requires BlackBerry "Mobile Threat Defense" to be enabled.
    */
